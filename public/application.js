...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkWins = function checkWins() {
	...
	var resetGameBoard = function resetGameBoard() {
	  ...
	  boxes.on('click', function (event) {
	    if ($(event.target).text() === '') {
	      ...
	      board[parseInt(event.target.id)] = currentPlayer;
	      console.log(board);
	      api.patchGame(store.game.id, event.target.id, currentPlayer, checkWins()).then(ui.success).catch(ui.failure);
	      turns();
	    } else {
	      console.log("pick another place");
	      $('.win').text("pick another place");
	...
	var onCreateGame = function onCreateGame(event) {
	  ...
	  }).then(ui.createGameSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	//   });
	// };
	var patchGame = function patchGame(id, indexNum, currentPlayer, checkWins) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetGame = function onGetGame(event) {
	  ...
	  api.game().then(ui.getGameSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// imports
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Rock+Salt);", ""]);
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Codystar);", ""]);
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Fascinate+Inline|Hanalei|Hanalei+Fill);", ""]);
